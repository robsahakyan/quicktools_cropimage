...
import oneInone from '../../assets/images/settings/1in1.png'
import custom from '../../assets/images/settings/custom.png'
import twointhree from '../../assets/images/settings/2in3.png'
import threeintwo from '../../assets/images/settings/3in2.png'
import threeinfour from '../../assets/images/settings/3in4.png'
import fourinthree from '../../assets/images/settings/4in3.png'
import nineinsixteen from '../../assets/images/settings/9in16.png'
import sixteeninnine from '../../assets/images/settings/16in9.png'
import aboutIcon from '../../assets/images/settings/aboutIcon.png'
import downloadIcon from '../../assets/images/settings/downloadIcon.png'
import measureIcon from '../../assets/images/settings/measureIcon.png'
...
export const SettingsPart: any = (props: any) => {
    ...
    function changeRadio(e: any) {
        ...
        let filteredObject = Object.fromEntries(Object.keys(cropOptions).map((key) => [key, false]))
        props.changeOptions({
            ...filteredObject,
            [e.target.value]: true
        })
        ...
        if (result) {
            props.changeCoordinates(changeCropSizes(e.target.value, props.imageProperties))
        }
    ...
    return (
        <div className={styles.settingsPart}>
            <div className={styles.settingsDiv1}>
                Format settings
            </div>
            <div className={styles.settingsDiv2}>
                <div className={styles.settingsDiv2Pgh}>
                    Crop Aspect Ratio
                </div>
            ...
            <div className={styles.settingsDiv4}>
                ...
                <div className={styles.measureIconPart}>
                    <Image src={measureIcon} alt="measureIcon" className={styles.measureIcon} />
                </div>
                <div className={styles.measurePart}>
                    <div className={styles.measurePgh}>
                        Enter Height
            ...
            <div className={styles.settingsDiv5}>
                <button className={styles.settingDiv5Button} disabled={!props.isReadyToShare} onClick={() => setToOpenPopUp(true)} >
                    <Image src={shareIcon} alt='shareIcon' />
                    <div className={styles.settingDiv5Context}>
                        Share image
                    </div>
                </button>
                <button className={styles.settingDiv5Button} id={styles.downloadButton} disabled={!props.isReadyToShare} onClick={downloadHandler}>
            ...
            {props.isReadyToShare && isOpenPopUp && <ShareImagePopUp aboutImage={props.aboutImage} setToOpenPopUp={setToOpenPopUp}/>}
        </div>
    )
}